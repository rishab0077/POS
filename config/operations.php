...
return [
    ...
    'monitoring' => [
        ...
        'scheduler_max_age_minutes' => (int) env('MONITORING_SCHEDULER_MAX_AGE_MINUTES', 3),
        'clock_max_skew_seconds' => (int) env('MONITORING_CLOCK_MAX_SKEW_SECONDS', 5),
        'cbms_pending_max_minutes' => (int) env('MONITORING_CBMS_PENDING_MAX_MINUTES', 15),
