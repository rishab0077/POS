...
class PDFHelper
{
    ...
    public static function saveBillToDisk($id)
    {
        ...
        $orderDetails = BillHelper::getBillOrders($id);
        ...
        self::saveAsPDF($restaurant, $billDetails, $orderDetails, $billFullId, $bill);
    ...
    public static function saveAsPDF($restaurant, $billDetails, $orderDetails, $billFullId, $bill = null)
    {
        $fileName = 'bill_' . $billFullId . '.pdf';
        $html = view('admin.bills.print', compact('billDetails', 'orderDetails', 'restaurant', 'bill'))->render();
