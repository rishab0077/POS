...
class TableHelper
{
    ...
    public static function markTableAsFinalized($tableId)
    {
    ...
    {
        self::markTableAsFinalized($tableId);
    }
    ...
    public static function markTableAsUnavailable($tableId)
    {
        $table = Table::where('id', $tableId)->first();
    ...
    {
        self::markTableAsUnavailable($tableId);
    }
