...
/**
 * @deprecated Direct PHP-host printer access is non-authoritative. Production
 * printing is performed by the authenticated print-station agent.
 */
class ThermalPrinter
{
    ...
    public function printKOT($kot, $billId, ?string $productionArea = null, string $ticketLabel = 'KOT')
    {
        ...
        $kotPrinter = new KOTPrinter($this->printer, $KOTDetails, $orderDetails, $bill_complete_id, $ticketLabel);
