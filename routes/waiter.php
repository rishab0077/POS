 ...
 * -----------------------------------------------------------------------------------------------------------------------------
 */
Route::middleware(['private.access', 'auth', 'waiter'])->name('waiter.')->prefix('waiter')->group(function () {
...
Route::middleware('public.access')->name('request.')->prefix('request')->group(function () {
