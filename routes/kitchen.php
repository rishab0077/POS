...
Route::middleware(['private.access', 'auth', 'kitchen'])->name('kitchen.')->prefix('kitchen')->group(function () {
    ...
    Route::get('/pending-orders', [KitchenController::class, 'pendingOrders'])->name('pending.orders');
