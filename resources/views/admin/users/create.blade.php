                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Lowercase letters, numbers, dots, underscores, and hyphens.</p>
                            @error('username')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <p class="text-xs text-gray-500 mt-1">At least 12 characters with letters and numbers.</p>
                            @error('password')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
                        </div>
