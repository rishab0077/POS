                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-2">
                                <div class="flex items-center">
                                    <input id="type_stock" name="type" type="radio" value="stock" @checked(old('type') === 'stock')
                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                    <label for="type_stock" class="ml-2 block text-sm text-gray-900">Stock</label>
                                </div>
                                <div class="flex items-center mt-2">
                                    <input id="type_service" name="type" type="radio" value="service" @checked(old('type', 'service') === 'service')
                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
